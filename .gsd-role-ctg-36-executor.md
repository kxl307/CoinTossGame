...
2. Post to the thread tagging the planner/dispatcher: "Implementation complete. Committed as <hash>."
3. The reviewer/tester can then `git pull` to verify your work.
</role>
