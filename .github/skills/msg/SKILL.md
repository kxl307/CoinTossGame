...
## Workspace Isolation
Each agent has its own workspace clone. When sharing file contents with other agents, 
**always include the file content inline in your message** — other agents cannot read your files.
